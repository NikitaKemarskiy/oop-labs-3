...
public class DoctorQuery {
    ...
    public static String FIND_BY_CATEGORIES_WITH_RELATIONS = "select doctors.*, \"doctorsCategories\".name as \"categoryName\" from doctors inner join \"doctorsCategories\" on doctors.\"categoryId\" = \"doctorsCategories\".id where \"categoryId\" in (%s)";
}